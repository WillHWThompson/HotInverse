function perimeter_constraint(individual::VoronoiIndividual,perimiter_constraint::Real,exponent::Real = 1)
...
function area_constraint(individual::VoronoiIndividual,area_constraint::Real,exponent::Real = 1)
